...
export const UI = {
  ...
  structureLens: t('格局法', 'Structure method'),
  lensNurtured: t('顺用', 'nurtured'),
  lensControlled: t('逆用', 'controlled'),
  lensWants: t('喜', 'wants'),
  lensFears: t('忌', 'fears'),
  lensAgree: t('与扶抑一致', 'agrees with the strength method'),
  lensPartial: t('与扶抑部分一致', 'partly agrees with the strength method'),
  lensDiffer: t('与扶抑不同 — 流派之别', 'differs from the strength method — a difference of school'),
  ...
  modeApart: t('各自', 'apart'),
  formSteady: t('稳', 'steady'),
  formLow: t('低', 'low'),
